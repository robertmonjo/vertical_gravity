...
Note: the paper (Monjo & Sasi 2026) reports baryonic chi2_nu ~ 194.7 using radius-dependent
...
```bibtex
@article{monjosasi2026vertical,
  author  = {Monjo, Robert and Sasi, A. E.},
